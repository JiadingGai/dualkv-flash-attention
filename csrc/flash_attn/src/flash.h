...
struct Flash_fwd_params : public Qkv_params {
    /* where to enable dualkv attention in flash attention*/
    bool use_dualkv_attention;

    // The k,v context (dualkv)
    void *__restrict__ kcontext_ptr;
    void *__restrict__ vcontext_ptr;

    // The k,v decoded (dualkv)
    ...
    // FIXME(jiadingg): refactor Flash_fwd_params to Flash_fwd_dualkv_params! 
