...
#include "flash_fwd_kernel_dualkv.h"
...
inline __device__ void compute_attn_splitkv(const Params &params) {
    ...
    if (params.use_dualkv_attention) {
      FLASH_NAMESPACE::compute_attn_1rowblock_splitkv_dualkv<Kernel_traits, Is_causal, Is_local, Has_alibi, Is_even_MN, Is_even_K, Is_softcap, Split, Append_KV>(params, bidb, bidh, m_block, n_split_idx, num_n_splits);
    } else {
