...
def flash_attn_with_kvcache(
    ...
    Arguments:
        ...
        use_dualkv_attention: bool. Whether to use dualkv+flash attention.
    ...
    if use_dualkv_attention:
        out, softmax_lse = flash_attn_gpu.fwd_kvcache_dualkv(
            q,
            k_cache_decoded,
            v_cache_decoded,
            k_cache_context,
