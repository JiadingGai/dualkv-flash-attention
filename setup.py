...
if not SKIP_CUDA_BUILD and not IS_ROCM:
    ...
    # Dualkv attention compilation control flags:
    # DUALKV_ATTENTION_DISABLE_UNSUPPORTED: disables code sections that are supported yet.
    # DUALKV_ATTENTION_DEBUG: turn on debug print.
    # DUALKV_ATTENTION_PARAMETER_TUNING: turn on kernel parameter tuning.
    dualkv_attention_flags = ["-DDUALKV_ATTENTION_DISABLE_UNSUPPORTED_CODE",]
    #dualkv_attention_flags += ["-DDUALKV_ATTENTION_DEBUG", "-DDUALKV_ATTENTION_PARAMETER_TUNING"]
    ext_modules.append(
        CUDAExtension(
            ...
            extra_compile_args={
                "cxx": ["-O3", "-std=c++17"] + dualkv_attention_flags,
